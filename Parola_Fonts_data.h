...
MD_MAX72XX::fontType_t ExtASCII[] PROGMEM =
{
  ...
  5, 56, 84, 85, 86, 88,    // 232 - 'e grave'		// 91 - '['
  5, 2, 4, 8, 16, 32,		// 92 - '\'
  5, 56, 84, 86, 85, 88,    // 233 - 'e acute'    // 93 - ']'
  5, 32, 84, 85, 122, 64,    // 224 - 'a grave'		// 94 - '^'
  ...
  3, 68, 125, 66,    // 236 - 'i grave'		// 123 - '{'
  5, 60, 65, 66, 32, 124,    // 249 - 'u grave'		// 124 - '|'
  5, 56, 68, 69, 70, 56,    // 242 - 'o grave'		// 125 - '}'
  5, 2, 1, 2, 4, 2,		// 126 - '~'
  0,		// 127 - 'Unused'
  ...
  5, 56, 84, 85, 86, 88,    // 232 - 'e grave'    // 168 - 'Spacing diaresis'
  ...
  1,2,		// 192 - 'A grave'
  1,4,		// 193 - 'A acute'
  1,6,		// 194 - 'A circumflex'
  0,		// primo carattere extended ascii // 195 - 'A tilde'
  1,17,		// 196 - 'A diaresis'
  1,33,		// 197 - 'A ring above'
  0, 		// 198 - 'AE'
